...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference("Salary.count") do
      post salaries_url, params: { salary: { amount: @salary.amount, employee_id: @salary.employee_id, end_date: @salary.end_date, start_date: @salary.start_date } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { amount: @salary.amount, employee_id: @salary.employee_id, end_date: @salary.end_date, start_date: @salary.start_date } }
